...
for i in range(2):
    ...
    for vacancy in vacancies:
        ...
        # вытаскиваю внутренний id вакансии из ссылки на нее и использую его как id в базе
        vacancy_el_in_list = vacancy_link.split('/')
        vacancy_id_in_list = vacancy_el_in_list[-1].split('?')
        vacancy_dict = {
            '_id': vacancy_id_in_list[0],
            'name': vacancy_name,
        ...
        try:
            ...
            print(f'Объект с _id: {vacancy_dict["_id"]} уже записан в колекцию')
